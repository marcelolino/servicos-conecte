...
export default function AdminReportsTransactions() {
  ...
  const metricsCards = [
    ...
    },
    {
      ...
      value: formatCurrency(reportData?.metrics.commissionRevenue || 0),
      icon: TrendingUp,
      color: 'text-green-600',
      bgColor: 'bg-green-100',
    },
    {
      title: 'Depósitos Requeridos',
      value: formatCurrency(reportData?.metrics.depositsRequired || 0),
      icon: FileText,
    ...
    },
    {
      ...
      value: formatCurrency(reportData?.metrics.lostGain || 0),
      icon: TrendingDown,
      color: 'text-red-600',
      bgColor: 'bg-red-100',
    },
    {
      ...
      value: formatCurrency(reportData?.metrics.completedGain || 0),
      icon: DollarSign,
